...
{
    public partial class ReportQuyetToanNhienLieuViewer : System.Web.UI.Page
    {
        ...
        public void LoadReport()
        {
            ...
            rd.SetParameterValue("@NgayTao", reportParam.valstring1);
            rd.SetParameterValue("@NgayChot", reportParam.valstring2);
            if (reportParam.ReportFileName == "BangQuyetToanNhienLieuPTCTB_CoKyNhay.rpt")
            {
