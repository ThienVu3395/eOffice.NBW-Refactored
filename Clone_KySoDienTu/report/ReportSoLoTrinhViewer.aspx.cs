...
{
    public partial class ReportSoLoTrinhViewer : System.Web.UI.Page
    {
        ...
        public void LoadReport()
        {
            ...
            rd.SetParameterValue("@BienSo", reportParam.valstring1);
            rd.SetParameterValue("@NgayTaoDon", reportParam.valstring2);
            rd.SetParameterValue("@TongSoKm", reportParam.valint1);
            rd.SetParameterValue("@NhienLieuTieuThu", reportParam.valint2);
            rd.SetParameterValue("@NhienLieuTonDauKy", reportParam.valint3);
            rd.SetParameterValue("@NhienLieuTonCuoiKy", reportParam.valint4);
            rd.SetParameterValue("@NhienLieuUngTruoc", reportParam.valint5);
            if(reportParam.ReportFileName == "SoLoTrinh_CoKyNhay.rpt")
            {
                rd.SetParameterValue("@HoTen", reportParam.valstring3);
                rd.SetParameterValue("@ChucVu", reportParam.valstring4);
                rd.SetParameterValue("@PhongBan", reportParam.valstring5);
                rd.SetParameterValue("@NgayKy", reportParam.valstring6);
            }
