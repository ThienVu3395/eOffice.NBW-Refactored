...
{
    public partial class ReportViewe : System.Web.UI.Page
    {
        ...
        public void LoadReport()
        {
            ...
            MoveReport(reportParam.ReportTitle + ".pdf", reportParam.IDVB);
        }

        public void MoveReport(string fileName,int IDVB)
        {
            ...
            using (IDbConnection db = new SqlConnection(_cnn))
            {
                ...
                dynamicParameters.Add("@VANBANID", IDVB);
                ...
                db.Execute("Report_ThemFileDinhKem", dynamicParameters, null, null, CommandType.StoredProcedure);
            }
        }
    }
}