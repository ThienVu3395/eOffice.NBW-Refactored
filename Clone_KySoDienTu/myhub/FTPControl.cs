...
namespace Clone_KySoDienTu.MyHub
{
    public class FTPControl
    {
        ...
        /* Construct Object */
        public FTPControl(string hostIP, string userName, string password) { host = hostIP; user = userName; pass = password; }
        ...
        /* Download File */
        public void downloadtoStream(string remoteFile, Stream localFileStream)
        {
            try
            {
                /* Create an FTP Request */
